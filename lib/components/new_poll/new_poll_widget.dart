...
export 'new_poll_model.dart';

class NewPollWidget extends StatefulWidget {
  const NewPollWidget({super.key});

  @override
  State<NewPollWidget> createState() => _NewPollWidgetState();
}

class _NewPollWidgetState extends State<NewPollWidget>
    with TickerProviderStateMixin {
  late NewPollModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewPollModel());
    ...
    _model.candidate2TextController ??= TextEditingController();
    _model.candidate2FocusNode ??= FocusNode();

    _model.candidate3TextController ??= TextEditingController();
    _model.candidate3FocusNode ??= FocusNode();

    _model.candidate4TextController ??= TextEditingController();
    _model.candidate4FocusNode ??= FocusNode();

    _model.candidate5TextController ??= TextEditingController();
    _model.candidate5FocusNode ??= FocusNode();
                                ...
                                child: InkWell(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await PollRecord.createDoc(
                                              currentUserReference!)
                                          .set(createPollRecordData(
                                        pollName:
                                            _model.pollNameTextController.text,
                                        option1: _model
                                            .candidate1TextController.text,
                                        option2: _model
                                            .candidate2TextController.text,
